class_name FeedCrackheadsQuest extends Quest

func _init(quest_type_in):
	QuestName = "Feeding Time"
	QuestDescription = "Feed the crackheads at leisure."
	type = quest_type_in
...
func add_objectives():
	var obj: FeedCrackheadsObjective = FeedCrackheadsObjective.new()
	add_objective(obj)
	pass

func _to_string():
	return str("FeedCrackheadsQuest{}")
